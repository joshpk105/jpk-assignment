...
class Authorship(db.Model):
    ...
    author_rel = db.relationship("As_Author", backref="author", cascade="all,delete", passive_deletes=True)
    book_rel = db.relationship("As_Book", backref="book", cascade="all,delete", passive_deletes=True)
...
class Ownership(db.Model):
    ...
    book_rel = db.relationship("Own_Book", backref="book", cascade="all,delete", passive_deletes=True)
    user_rel = db.relationship("Own_User", backref="user", cascade="all,delete", passive_deletes=True)
